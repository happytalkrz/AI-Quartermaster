...
import type { PhaseResult, ModelCostEntry } from "../../types/pipeline.js";
...
import type { PhaseExecutorContext } from "./phase-executor.js";
...
export class ClaudePhaseExecutor implements PhaseExecutor {
  async execute(ctx: PhaseExecutorContext): Promise<PhaseResult> {
