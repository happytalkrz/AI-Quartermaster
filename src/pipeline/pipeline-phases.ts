...
export async function executePostProcessingPhases(
  ...
  // CI 체크 Phase - 비활성화 (pollCiStatus가 즉시 failure 판정하는 버그 — #284 수정 필요)
  // TODO: pollCiStatus에서 pending/queued 상태 대기 로직 추가 후 활성화
  logger.info("CI auto-check disabled — skipping CI check phase");

  /* CI auto-check disabled — pollCiStatus가 pending 대기 없이 즉시 failure 판정하는 버그
   * TODO: #284 수정 — pending/queued 상태 대기 로직 추가 후 활성화
   */
