...
echo ""
echo "Usage:"
echo "  aqm setup                                       Initial setup"
echo "  aqm start                                       Start webhook server"
echo "  aqm start --mode polling [--interval <sec>]     Start in polling mode"
echo "  aqm run --issue 42 --repo org/repo              Run pipeline manually"
echo "  aqm doctor                                      Environment check"
echo "  aqm plan --repo org/repo                        Analyze issues"
echo "  aqm stats                                       Show statistics"
echo "  aqm status                                      Queue status"
echo "  aqm resume --job <id>                           Resume failed pipeline"
echo "  aqm update                                      Update AQM"
echo "  aqm version                                     Show version"
echo "  aqm uninstall                                   Uninstall"
echo ""
